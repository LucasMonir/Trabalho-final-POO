...
public class Apk {
    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                            ...
                            switch (subOp) {
                                case 5:
                                    if (listaClientes.size() != 0) {
                                        subOp = Integer.parseInt(JOptionPane.showInputDialog(
                                        ...
                                        JOptionPane.showMessageDialog(null,
                                                "Lista se encontra vazia, retornando ao menu!", "Erro na lista",
                ...
                JOptionPane.showMessageDialog(null, e.getMessage(), "Erro relacionado a lista",
                        JOptionPane.ERROR_MESSAGE);
                if (op == 2) {
                    op = 5;
                }
                ...
                JOptionPane.showMessageDialog(null, e.getMessage(), "Erro na geração de aviso",
                        JOptionPane.ERROR_MESSAGE);
                subOp = 5;
                ...
                JOptionPane.showMessageDialog(null, "Data inválida, voltando a tela inicial",
                        "Erro de preenchimento de data", JOptionPane.ERROR_MESSAGE);
                subOp = 5;
            }
        } while (op != 6);
    }
    ...
    private static void incluir()
            throws ParseException, SituacaoException, PreenchimentoException, NumberFormatException {
        ...
        int x = JOptionPane.showOptionDialog(null,
                ...
                "ATENÇÃO", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
        ...
        x = JOptionPane.showOptionDialog(null, "Nova inclusão?", "ATENÇÃO", JOptionPane.DEFAULT_OPTION,
    ...
    private static void alterar() throws ParseException, ListaException {
        ...
        if (listaClientes.size() != 0) {
            ...
            do {
                switch (modo) {
                    case 0:
                        modo = Integer.parseInt(JOptionPane.showInputDialog(
                        ...
                        for (Cliente cliente : listaClientes) {
                            if (cliente.getCpf() == cpf) {
                                ...
                                if (x == 0) {
                                    ...
                                    JOptionPane.showMessageDialog(null, "Alteração cancelada, voltando ao menu!",
                                            "Operação cancelada", JOptionPane.ERROR_MESSAGE);
                                }
                            }
                        }
                    ...
                    case 2:
                        ...
                        for (Cliente cliente : listaClientes) {
                            if (cliente.getCpf() == cpf) {
                                double novoDebito = Double
                                        .parseDouble(JOptionPane.showInputDialog("Insira novo débito:"));

                                x = JOptionPane.showOptionDialog(null,
                                        "Confirmar alteração de débito?\n" + "Novo débito: " + novoDebito, "ATENÇÃO",
                                        JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options,
                                        options[0]);
                    ...
                    case 3:
                        ...
                        for (Cliente cliente : listaClientes) {
                            if (cliente.getCpf() == cpf) {
                                ...
                                x = JOptionPane.showOptionDialog(null,
                                        "Confirmar alteração de data e débito?\n" + "Nova data: " + novaData + "\n"
                                                + "Novo débito: " + novoDebito,
                                        "ATENÇÃO", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null,
                                        options, options[0]);
                    ...
                    default:
                        JOptionPane.showMessageDialog(null, "Opção inválida, retornando!", "Operação cancelada",
                                JOptionPane.ERROR_MESSAGE);
                        modo = 0;
                }
            } while (modo != 4);
        ...
        x = JOptionPane.showOptionDialog(null, "Nova alteração?", "ATENÇÃO", JOptionPane.DEFAULT_OPTION,
                JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
        if (x == 0) {
            alterar();
        }
    ...
    private static void exclusao() throws ListaException, IllegalStateException {
        ...
        if (listaClientes.size() != 0) {
            ...
            while (iter.hasNext()) {
                ...
                if (cli.getCpf() == cpf) {
                    ...
                    x = JOptionPane.showOptionDialog(null, "Confirmar Exclusão?", "ATENÇÃO", JOptionPane.DEFAULT_OPTION,
                            JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
                    if (x == 0) {
                        iter.remove();
                    } else {
        ...
        x = JOptionPane.showOptionDialog(null, "Nova exclusão?", "ATENÇÃO", JOptionPane.DEFAULT_OPTION,
                JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
        if (x == 0) {
            exclusao();
        }
    ...
    private static void movimentacaoBaixa() throws ListaException, ParseException, NumberFormatException {
        ...
        if (listaClientes.size() != 0) {
            ...
            for (Cliente cliente : listaClientes) {
                if (cliente.getCpf() == cpf) {
                    ...
                    x = JOptionPane.showOptionDialog(null,
                            "Confirmar baixa de tiítulo no valor de R$: " + quantia + " ?", "ATENÇÃO",
                    ...
                    if (x == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Valor final: " + formatoDouble.format(cliente.getDebito()));
                    } else {
                        JOptionPane.showMessageDialog(null, "Operação cancelada pelo usuário, voltando ao menu!");
                    }
        ...
        x = JOptionPane.showOptionDialog(null, "Nova baixa?", "ATENÇÃO", JOptionPane.DEFAULT_OPTION,
                JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
        if (x == 0) {
            movimentacaoBaixa();
        }
