...
public class Relatorios{
    ...
    private static String balancoToString(List<Mes> listaMeses){
        ...
        for (Mes mes : listaMeses) {
            balanco+=mes.getNome()+": "
            + formatoDouble.format(mes.getInadimplencia())
            +" R$ \n================================================================================\n";
    ...
    public static String maioresDevedores(Set<Cliente> listaClientes){
        ...
        if(counter<10){
            for(int i=1;i<=counter;i++){
                ...
                devedoresString+=(i)+" - "+devedor.getNome()+": "+formatoDouble.format(devedor.getDebito())+" R$"
                +" \n________________________________________________________________________________ \n";
            }
        }else{
            for(int i=1;i<=10;i++){
    ...
    //Criação de um criterio de comparação, utiliza o valor dos debitos passados para strings
    ...
    //metodo para fornecer meses a lista de meses e limpar a lista para garantir não duplicidade
    ...
    public static String situacaoToString(Cliente cliente, String aviso){
        ...
        +"O Sr. Nos deve a quantia de R$ "+formatoDouble.format(cliente.getDebito())
